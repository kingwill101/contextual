...
Future<void> main() async {
  final config = TypedLogConfig(
    ...
    channels: [
      ...
      DailyFileChannel(const DailyFileOptions(path: 'logs/app', retentionDays: 7), name: 'file'),
      StackChannel(const StackOptions(channels: ['consoleA', 'file'], ignoreExceptions: true), name: 'stacked'),
      SamplingChannel(SamplingOptions(rates: {Level.debug: 0.5}, wrappedChannel: 'stacked'), name: 'sampled'),
    ],
  );
