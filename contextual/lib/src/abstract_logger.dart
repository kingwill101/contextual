...
abstract class AbstractLogger implements LoggerInterface {
  ...
  void emergency(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.emergency, message, context, stackTrace);
  }
  ...
  void alert(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.alert, message, context, stackTrace);
  }
  ...
  void critical(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.critical, message, context, stackTrace);
  }
  ...
  void error(Object message, [Object? context, StackTrace? stackTrace]) {
  ...
  void warning(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.warning, message, context, stackTrace);
  }
  ...
  void notice(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.notice, message, context, stackTrace);
  }
  ...
  void info(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.info, message, context, stackTrace);
  }
  ...
  void debug(Object message, [Object? context, StackTrace? stackTrace]) {
    log(Level.debug, message, context, stackTrace);
  }
}
