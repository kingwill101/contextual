...
- **[API Reference](/api/overview)**: Dive deeper into Contextual's classes, methods, and configuration options.
- **[Advanced Features](/advanced/middleware)**: Learn about middleware for transforming logs, batching for performance, and integrating with frameworks like Shelf.
- **[Driver Guides](/api/drivers/daily-file)**: Explore specific drivers for file logging, webhooks, and more.
- **[Migration Guide](/migration/v2)**: If upgrading from v1, see how to migrate your code to the new typed APIs.
- **[Type Formatters & Printers](/advanced/type-formatters)**: Customize how domain objects and structured data appear in logs.
...
For more examples and best practices, check out the [API Reference](/api/overview), [Advanced Topics](/advanced/middleware), and [Type Formatters & Printers](/advanced/type-formatters).
