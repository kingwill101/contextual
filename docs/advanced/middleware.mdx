---
title: Middleware
description: Transform, enrich, and filter Contextual log entries across global, channel, and driver pipelines.
---
...
- [Driver Configuration](../api/drivers/configuration.mdx)
