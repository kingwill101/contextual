...
description: Install Contextual, configure your first logger, and learn key concepts quickly.
---
...
- Check out the [API Reference](api/overview.mdx) for detailed documentation
- Learn about [Advanced Features](advanced/middleware.mdx)
- Explore [Driver Guides](api/drivers/daily-file.mdx) for configuration examples
