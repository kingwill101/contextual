...
Type formatters work with the new serialization system. For a deeper dive, including real-world patterns and custom printers, see [Type Formatters & Printers](../advanced/type-formatters.mdx).
...
- [Middleware Guide](../advanced/middleware.mdx)
- [Migration to v2](../migration/v2.mdx)
- [Type Formatters & Printers](../advanced/type-formatters.mdx)
