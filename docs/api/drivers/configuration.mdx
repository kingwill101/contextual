...
description: Configure typed channels and options for Console, File, Webhook, and more.
---
...
- `wrappedChannel`: The channel to sample (must reference an existing channel name)
